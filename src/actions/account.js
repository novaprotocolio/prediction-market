...
import { saveLoginData, loadAccountNovaAuthentication } from '../lib/session';
...
export const loadAccount = address => {
  return (dispatch, getState) => {
    ...
    const jwt = loadAccountNovaAuthentication(address);
    if (jwt && !isLoggedIn) {
...
export const login = (address, novaAuthentication) => {
  return (dispatch, getState) => {
