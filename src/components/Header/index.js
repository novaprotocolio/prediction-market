...
const mapStateToProps = state => {
  return {
    ...
    currentAugur: state.market.getIn(['markets', 'currentAugur']),
    augurs: state.market.getIn(['markets', 'data']),
  ...
  render() {
    ...
    return (
      <div className="navbar bg-blue navbar-expand-lg">
        <img className="navbar-brand" src={require('../../images/nova.svg')} alt="nova" />
        ...
        <a
          href="https://novaprotocol.io/developers/docs/overview/what-is-nova.html"
